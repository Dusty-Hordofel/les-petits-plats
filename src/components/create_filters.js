...
<div class="filter__ingredients--container">
  <div class="filter__ingredients__title">
  <h2 class="filter__ingredients__title--name">Ingredients</h2>
  <span class="fa-solid fa-chevron-down filter__ingredients__title--icon--down"></span>
  </div>

  <input id="ingredients-input" type="text" class="filter__ingredients--input" placeholder="Rechercher un ingrédient..." />
  <span class="fa-solid fa-chevron-up filter__ingredients__title--icon--up"></span>
